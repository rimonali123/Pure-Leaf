...
const StickerCard = () => {
    return (
        <div className="flex justify-between w-full mx-auto mt-10">
            <div className="max-w-xs text-center w-full mx-auto border-r-2 border-black dark:bg-gray-50 dark:text-gray-900" >
            ...
            <div className="max-w-xs text-center w-full mx-auto  border-black dark:bg-gray-50 dark:text-gray-900" >
